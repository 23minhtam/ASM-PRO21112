        ...
        <ul class="metismenu " id="sidebarNav">
            ...
            <li>
                <a href="#!brand" aria-expanded="false">
                    ...
                    <span class="nav-title">Brands Manager</span>
                </a> 
            </li>
            <li>
                <a href="#!category" aria-expanded="false">
                    <i class="fa-solid fa-boxes-stacked"></i>
                    <span class="nav-title">Category Manager</span>
                </a>
            </li>
            <li>
                <a href="#!product" aria-expanded="false">
                    <i class="fas fa-box-open"></i>
                    <span class="nav-title">Products Manager</span>
                </a>
            </li>
            <li>
                <a href="#!order" aria-expanded="false">
                    <i class="fas fa-file-invoice-dollar"></i>
                    <span class="nav-title">Orders Manager</span>
                </a>
            </li>
            <li>
