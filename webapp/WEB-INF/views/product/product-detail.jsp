				...
				<div id="ProductSection-product-template"
					...
					<div class="product-single">
								...
								<div class="product-single__meta">
									...
									<div class="display-table shareRow">
										<c:if test="${not empty sessionScope.user }">
											<div class="variants add" action="#" method="post" class="display-table-cell medium-up--one-third">
												<div class="wishlist-btn">
													<a class="wishlist add-to-wishlist" href="#"
														title="Add to Wishlist"><i
														class="icon anm anm-heart-l" aria-hidden="true"></i> <span
														type="button" ng-click="wishlist.add(${d.product.id})">Thêm
								...
								<div class="product-info">
									<p class="product-type">
										...
										<c:forEach var="c"
											...
											<a href="/product/list?cid=${c.category.id}">${c.category.name}</a>
									</p>
									</c:forEach>
						...
						<div
							...
							class="comment">
							<h5
								style="padding-left: 20px; margin: 0; position: relative; top: 10px; color: #000000; font-weight: 600;">Bình
								Luận</h5>
